                                        ...
                                        slots={[
                                            ...
                                            >
                                                ...
                                                <RichText
                                                    ...
                                                    data-framer-name={'Aegra'}
                                                    fonts={[
                                                        'GF;Bricolage Grotesque-regular',
                                                    ]}
                                                    layoutDependency={
                                                        layoutDependency
                                                    }
...
var css3 = [
    ...
    '.framer-omc0b.framer-1jv9jw3, .framer-omc0b .framer-1jv9jw3 { display: block; }',
    '.framer-omc0b.framer-9n4rdh { align-content: center; align-items: center; display: flex; flex-direction: column; flex-wrap: nowrap; gap: 100px; height: min-content; justify-content: flex-start; overflow: hidden; padding: 0px 100px 40px 100px; position: relative; width: 1200px; }',
    '.framer-omc0b .framer-1inqsug { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 15px; height: min-content; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: 100%; z-index: 1; }',
    '.framer-omc0b .framer-6uzw6x { flex: none; height: auto; position: relative; white-space: pre; width: auto; z-index: 0; }',
    '.framer-omc0b .framer-ptb27k-container { flex: none; height: 33px; max-width: 1000px; position: relative; width: 100%; }',
    '.framer-omc0b .framer-kpez2r { align-content: center; align-items: center; display: flex; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 24px; justify-content: center; overflow: visible; padding: 0px; position: relative; width: min-content; }',
    '.framer-omc0b .framer-1pjkn8 { flex: none; height: 18px; position: relative; width: 18px; }',
    '.framer-omc0b .framer-ncsa12, .framer-omc0b .framer-11vzbki, .framer-omc0b .framer-sfzn2n, .framer-omc0b .framer-1iy7nmp, .framer-omc0b .framer-40twg2, .framer-omc0b .framer-hvwyme, .framer-omc0b .framer-xzjtzd, .framer-omc0b .framer-nh9fdn { flex: none; height: auto; position: relative; white-space: pre; width: auto; }',
    '.framer-omc0b .framer-1o4ieja { align-content: center; align-items: center; display: flex; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 21px; justify-content: center; overflow: visible; padding: 0px; position: relative; width: min-content; }',
    '.framer-omc0b .framer-58nlp3 { flex: none; height: 22px; position: relative; width: 30px; }',
    '.framer-omc0b .framer-1f0jvxg, .framer-omc0b .framer-1f9ha54 { align-content: center; align-items: center; display: flex; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 28px; justify-content: center; overflow: visible; padding: 0px; position: relative; width: min-content; }',
    '.framer-omc0b .framer-1eqmj5j { flex: none; height: 19px; position: relative; width: 30px; }',
    '.framer-omc0b .framer-1e7tk0c, .framer-omc0b .framer-tw696m { align-content: center; align-items: center; display: flex; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 26px; justify-content: center; overflow: visible; padding: 0px; position: relative; width: min-content; }',
    '.framer-omc0b .framer-wizlf6 { flex: none; height: 26px; position: relative; width: 23px; }',
    '.framer-omc0b .framer-1p5zyzb { flex: none; height: 24px; overflow: visible; position: relative; width: 24px; }',
    '.framer-omc0b .framer-fldsrd { aspect-ratio: 1 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 6px); left: 0px; position: absolute; top: 0px; width: 6px; }',
    '.framer-omc0b .framer-16cxk40 { aspect-ratio: 1 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 6px); left: 9px; position: absolute; top: 0px; width: 6px; }',
    '.framer-omc0b .framer-3yn0e { aspect-ratio: 1 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 6px); left: 0px; position: absolute; top: 9px; width: 6px; }',
    '.framer-omc0b .framer-1o7ltjs { aspect-ratio: 1 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 6px); left: 9px; position: absolute; top: 9px; width: 6px; }',
    '.framer-omc0b .framer-1at0acx { aspect-ratio: 1 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 6px); left: 18px; position: absolute; top: 9px; width: 6px; }',
    '.framer-omc0b .framer-18vwn94 { aspect-ratio: 1 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 5px); left: 0px; position: absolute; top: 19px; width: 6px; }',
    '.framer-omc0b .framer-1uiexxw { aspect-ratio: 1 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 5px); left: 9px; position: absolute; top: 19px; width: 6px; }',
    '.framer-omc0b .framer-1foh7nc { flex: none; height: 29px; position: relative; width: 29px; }',
    '.framer-omc0b .framer-suncao, .framer-omc0b .framer-167ns4s { align-content: center; align-items: center; display: flex; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 22px; justify-content: center; overflow: visible; padding: 0px; position: relative; width: min-content; }',
    '.framer-omc0b .framer-a4lsxi { flex: none; height: 22px; position: relative; width: 27px; }',
    '.framer-omc0b .framer-1qgl5lv { flex: none; height: 16px; position: relative; width: 49px; }',
    '.framer-omc0b .framer-t17l28 { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 39px; height: min-content; justify-content: center; max-width: 1100px; overflow: visible; padding: 0px; position: relative; width: 100%; z-index: 2; }',
    '.framer-omc0b .framer-16o3jbg { align-content: center; align-items: center; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: 288px; justify-content: center; overflow: visible; padding: 0px; position: relative; width: 1px; z-index: 1; }',
    '.framer-omc0b .framer-pmwh6r-container { flex: none; height: auto; position: relative; width: 242px; z-index: 2; }',
    '.framer-omc0b .framer-18o74te { bottom: 0px; flex: none; left: 0px; overflow: visible; position: absolute; right: 0px; top: 0px; z-index: 1; }',
    '.framer-omc0b .framer-cxj5db { align-content: center; align-items: center; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: nowrap; gap: 25px; height: min-content; justify-content: center; overflow: visible; padding: 0px; position: relative; width: 1px; z-index: 2; }',
    '.framer-omc0b .framer-1i0dr21 { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 20px; height: min-content; justify-content: center; overflow: visible; padding: 0px; position: relative; width: 100%; z-index: 2; }',
    '.framer-omc0b .framer-2xc4pj { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; overflow: visible; padding: 0px; position: relative; width: 100%; }',
    '.framer-omc0b .framer-18lr4bt, .framer-omc0b .framer-1q9ne7l { flex: none; height: auto; position: relative; white-space: pre-wrap; width: 100%; word-break: break-word; word-wrap: break-word; z-index: 1; }',
    '.framer-omc0b .framer-1hel76v-container { flex: none; height: auto; position: relative; width: auto; z-index: 2; }',
    '.framer-omc0b .framer-pof1yx { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: 800px; justify-content: center; overflow: hidden; padding: 0px; position: absolute; right: 0px; top: 0px; width: 100%; z-index: 1; }',
    '.framer-omc0b .framer-1ddsyz7-container { flex: none; height: 800px; left: calc(50.00000000000002% - 100% / 2); position: absolute; top: 0px; width: 100%; z-index: 0; }',
    '.framer-omc0b.framer-v-zax2vy.framer-9n4rdh { gap: 50px; padding: 0px 40px 40px 40px; width: 810px; }',
    '.framer-omc0b.framer-v-zax2vy .framer-1inqsug, .framer-omc0b.framer-v-zax2vy .framer-16o3jbg { order: 0; }',
    '.framer-omc0b.framer-v-zax2vy .framer-t17l28 { gap: 32px; max-width: 810px; order: 1; }',
    '.framer-omc0b.framer-v-zax2vy .framer-18o74te { bottom: -1px; right: 0px; z-index: 0; }',
    '.framer-omc0b.framer-v-zax2vy .framer-cxj5db { gap: 21px; max-width: 700px; order: 1; }',
    '.framer-omc0b.framer-v-zax2vy .framer-pof1yx { order: 2; }',
    '.framer-omc0b.framer-v-1cg770z.framer-9n4rdh { gap: 120px; padding: 0px 20px 80px 20px; width: 390px; }',
    '.framer-omc0b.framer-v-1cg770z .framer-t17l28 { flex-direction: column; gap: 48px; z-index: 1; }',
    '.framer-omc0b.framer-v-1cg770z .framer-16o3jbg { flex: none; height: min-content; order: 1; width: 100%; }',
    '.framer-omc0b.framer-v-1cg770z .framer-18o74te { bottom: unset; height: 205px; left: calc(50.00000000000002% - 350px / 2); right: unset; top: calc(77.2727272727273% - 205px / 2); width: 350px; z-index: 0; }',
    '.framer-omc0b.framer-v-1cg770z .framer-cxj5db { flex: none; gap: 50px; order: 0; width: 100%; }',
    '.framer-omc0b.framer-v-1cg770z .framer-1i0dr21 { align-content: center; align-items: center; gap: 12px; max-width: 600px; }',
    '.framer-omc0b.framer-v-1cg770z .framer-1q9ne7l { max-width: 540px; }',
    '.framer-omc0b.framer-v-1cg770z .framer-pof1yx { z-index: 0; }',
    ...css2,
    ...css,
]
...
addPropertyControls2(FramerFBnWH0oiT, {
    variant: {
