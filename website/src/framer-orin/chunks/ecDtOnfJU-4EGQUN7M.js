...
var Component = /* @__PURE__ */ React.forwardRef(function (props, ref) {
  ...
  return /* @__PURE__ */ _jsx(SVG, {
    ...restProps,
    className: cx('framer-JK0qE', className),
    layoutId,
    ref,
    role: 'presentation',
    style: {
...
var css = [
  `.framer-JK0qE { -webkit-mask: ${mask}; aspect-ratio: 1; display: block; mask: ${mask}; width: 24px; }`,
]
  ...
  exports: {
    default: {
      ...
      annotations: {
        ...
        framerVector:
          '{"name":"Chart Bar","color":{"type":"variable","value":"21h8s6"},"set":{"localId":"vectorSet/NGVKdicsm","id":"NGVKdicsm","moduleId":"omX0gWFPqDwhaiWwf6ab"}}',
        framerVariables:
