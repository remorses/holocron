...
var Component = /* @__PURE__ */ React.forwardRef(function(props, ref) {
  ...
  return /* @__PURE__ */ _jsx2(SVG, { ...restProps, className: cx("framer-Lvnjs", className), layoutId, ref, style: { "--13bnw74": HN7TZix3o, ...style } });
});
var css = [`.framer-Lvnjs { aspect-ratio: 1; background-color: var(--13bnw74); mask-image: url('data:image/svg+xml,<svg display="block" role="presentation" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M 0 0 L 0 12.5" fill="transparent" height="12.5px" id="NaIfqRgGS" stroke-dasharray="0" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="var(--13bnw74, rgb(255, 255, 255))" transform="translate(12 6)" width="1px"/><path d="M 0 0 L 12.5 0" fill="transparent" height="1px" id="uFe8JI3Rq" stroke-dasharray="0" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="var(--13bnw74, rgb(255, 255, 255))" transform="translate(5.5 12)" width="12.5px"/></svg>'); mask-position: center; mask-repeat: no-repeat; width: 24px; }`];
var Icon = withCSS(Component, css, "framer-Lvnjs");
var stdin_default = Icon;
addPropertyControls2(Icon, { HN7TZix3o: { defaultValue: "rgb(255, 255, 255)", hidden: false, title: "Color", type: ControlType2.Color } });
