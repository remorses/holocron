...
// /:https://framerusercontent.com/modules/ucIqmdXFlkfhojY0CsdL/vGqqMi80rAy0djAvbNER/lezer_markdown.js
...
// /:https://framerusercontent.com/modules/ew2kgXFUVzaNY5ZWXtC5/J14V34cIuapfGKlb2Lar/codemirror_lang_markdown.js
    ...
    if (range.empty && markdownLanguage.isActiveAt(state, range.from)) {
      ...
      if (context.length) {
        ...
        (!inner.item || line.from <= inner.item.from || !/\S/.test(line.text.slice(0, inner.to)))) {
          ...
          if (inner.item && inner.node.from < inner.item.from && /\S/.test(line.text.slice(inner.from, inner.to))) return { range, changes: { from: start, to: line.from + inner.to, insert: inner.blank(inner.to - inner.from) } };
...
var __FramerMetadata__ = { "exports": { "markdownKeymap": { "type": "variable", "annotations": { "framerContractVersion": "1" } }, "markdownLanguage": { "type": "variable", "annotations": { "framerContractVersion": "1" } }, "deleteMarkupBackward": { "type": "variable", "annotations": { "framerContractVersion": "1" } }, "commonmarkLanguage": { "type": "variable", "annotations": { "framerContractVersion": "1" } }, "insertNewlineContinueMarkup": { "type": "variable", "annotations": { "framerContractVersion": "1" } }, "markdown": { "type": "function", "annotations": { "framerContractVersion": "1" } }, "__FramerMetadata__": { "type": "variable" } } };
export {
  __FramerMetadata__,
  commonmarkLanguage,
