...
// /:https://framerusercontent.com/modules/EjGlVHogpfm3jPPe6dpv/eQhPEFC9g4r1lCZecWdn/lezer_python.js
var printKeyword = 1
var indent = 196
var dedent = 197
var newline$1 = 198
...
var formatString1 = formatString(
  singleQuote,
  1,
...
var formatString2 = formatString(
  doubleQuote,
  1,
...
var formatString1l = formatString(
  singleQuote,
  3,
...
var formatString2l = formatString(
  doubleQuote,
  3,
...
// /:https://framerusercontent.com/modules/NlaGw745MKw3pDtavCDw/xGaFw5cOVjKh18HQenoz/codemirror_lang_python.js
...
function getScope(doc, node) {
  ...
  node.cursor(IterMode.IncludeAnonymous).iterate((node2) => {
    if (node2.name) {
      ...
      if (
        (gather && gather(node2, def, top)) ||
        (!top && ScopeNodes.has(node2.name))
      )
        return false
      top = false
...
var globalCompletion = /* @__PURE__ */ ifNotIn(
  dontComplete,
