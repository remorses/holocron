...
var tM = class {
  ...
  write(t32, e42) {
    let r2 = t32, n22 = r2 + e42.length, i22 = 0, s22 = this.chunks.length;
    for (; i22 < s22; i22++) {
    ...
    let a2 = { start: r2, end: n22, data: e42 }, o22 = s22 - i22;
...
var tO = class {
  scanItems() {
    return this.itemsPromise ??= tL(this.url).then(async (t32) => {
      ...
      let e42 = await t32.arrayBuffer(), r2 = new Uint8Array(e42), n22 = new y(r2), i22 = [], s22 = n22.readUint32();
  ...
  constructor(t32, e42) {
    this.id = t32, this.url = e42, c(this, "itemsPromise"), c(this, "itemLoader", new g.default(async (t4) => {
      ...
      return r2.map((e6, r3) => {
        let n22 = new y(e6), i22 = tA.read(n22), s22 = t4[r3];
...
var tx = class {
  ...
  constructor(t32) {
    this.options = t32, c(this, "schema"), c(this, "indexes"), c(this, "resolveRichText"), c(this, "resolveVectorSetItem"), c(this, "chunks"), this.chunks = this.options.chunks.map((t4, e42) => new tO(e42, t4)), this.schema = t32.schema, this.indexes = t32.indexes, this.resolveRichText = t32.resolveRichText, this.resolveVectorSetItem = t32.resolveVectorSetItem;
  }
};
...
// /:https://framerusercontent.com/modules/68ZL9LCxtjilYrv52eBl/7OILITIhzFYpTJqux8Kf/BjvKQJNV8.js
var n2 = { eQ710bws0: { isNullable: true, type: t3.String }, id: { isNullable: false, type: t3.String }, nextItemId: { isNullable: true, type: t3.String }, PfZk8Jfkg: { isNullable: true, type: t3.String }, previousItemId: { isNullable: true, type: t3.String } };
var o2 = [];
var u2 = (e22) => {
  let t22 = o2[e22];
...
var p2 = new i2();
var d2 = new l2(p2);
var s2 = { collectionByLocaleId: { default: new tx({ chunks: [new URL("./BjvKQJNV8-chunk-default-0.framercms", "https://framerusercontent.com/modules/68ZL9LCxtjilYrv52eBl/7OILITIhzFYpTJqux8Kf/BjvKQJNV8.js").href.replace("/modules/", "/cms/")], indexes: [], resolveRichText, resolveVectorSetItem: u2, schema: n2 }) }, displayName: "Categories" };
var stdin_default = s2;
e4(s2, { PfZk8Jfkg: { defaultValue: "", title: "Title", type: t3.String }, eQ710bws0: { title: "Slug", type: t3.String }, previousItemId: { dataIdentifier: "local-module:collection/BjvKQJNV8:default", title: "Previous", type: t3.CollectionReference }, nextItemId: { dataIdentifier: "local-module:collection/BjvKQJNV8:default", title: "Next", type: t3.CollectionReference } });
