...
var Component = /* @__PURE__ */ React.forwardRef(function (props, ref) {
  ...
  return /* @__PURE__ */ _jsx(SVG, {
    ...restProps,
    className: cx('framer-INa10', className),
    layoutId,
    ref,
    role: 'presentation',
    style: {
...
var css = [
  `.framer-INa10 { -webkit-mask: ${mask}; aspect-ratio: 1; display: block; mask: ${mask}; width: 24px; }`,
]
...
var __FramerMetadata__ = {
  exports: {
    default: {
      ...
      annotations: {
        framerVector:
          '{"name":"Link","color":{"type":"variable","value":"21h8s6"},"set":{"localId":"vectorSet/NGVKdicsm","id":"NGVKdicsm","moduleId":"omX0gWFPqDwhaiWwf6ab"}}',
