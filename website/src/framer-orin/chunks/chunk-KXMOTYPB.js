...
// /:https://framerusercontent.com/modules/2B1yVjX9TEUbuHzHLnih/slPptusM3aarmySLiAK2/lezer_javascript.js
var noSemi = 302
var incdec = 1
var incdecPrefix = 2
var insertSemi = 303
...
// /:https://framerusercontent.com/modules/YrJiUSsP9WZPvnJAGTTV/lsyxtesB0g1ydwxUh1t0/codemirror_lang_javascript.js
...
// /:https://framerusercontent.com/modules/GrkjcC7Ol5LkBvrp44De/6z7UMqAq3iGnlCYUf9GL/lezer_html.js
var scriptText = 54
...
// /:https://framerusercontent.com/modules/baxvQBtmpZ5GFXZ1GP2Q/H0MWM2nOs0wKqaypim0h/lezer_css.js
var descendantOp = 95
var Unit = 1
var callee = 96
var identifier = 97
...
var parser3 = LRParser.deserialize({
  ...
  specialized: [
    ...
    { term: 97, get: (value) => spec_identifier2[value] || -1 },
  ],
  tokenPrec: 1142,
})

// /:https://framerusercontent.com/modules/Gg5hLFaRxQ2EaXSWb101/NVSL3b7ItCp8LKQ0X8xX/codemirror_lang_css.js
...
function isVarArg(node, doc) {
  ...
  if (
    (callee2 === null || callee2 === void 0 ? void 0 : callee2.name) != 'Callee'
  )
    return false
...
// /:https://framerusercontent.com/modules/ju8TqAduufCaScL3E39X/Hdr5EfbJpb0U6GIV3I5O/codemirror_lang_html.js
...
function completeAttrName(state, schema, tree, from, to) {
  let elt = findParentElement(tree),
    info = elt ? schema.tags[elementName2(state.doc, elt)] : null
...
function htmlCompletionSourceWith(config) {
  ...
  let schema =
    extraAttrs || extraTags ? new Schema(extraTags, extraAttrs) : Schema.default
...
var autoCloseTags2 = /* @__PURE__ */ EditorView.inputHandler.of(
  (view, from, to, text) => {
    if (
      view.composing ||
      view.state.readOnly ||
      ...
      if (text == '>' && around.name == 'OpenTag') {
        if (
          ((_b =
            ...
            ? void 0
            : _b.name) != 'CloseTag' &&
          (name = elementName2(state.doc, around.parent, head)) &&
        ...
        if (
          ...
          ((_c = base.lastChild) === null || _c === void 0
            ? void 0
            : _c.name) != 'CloseTag' &&
          (name = elementName2(state.doc, base, head)) &&
          !selfClosers2.has(name)
        ) {
          let hasRightBracket =
            view.state.doc.sliceString(head, head + 1) === '>'
...
export { css, javascriptLanguage, javascript, htmlLanguage, html }
