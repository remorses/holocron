...
function getCollectionData(collectionList) {
  ...
  const propertyControlsById = (queryData === null || queryData === void 0 ? void 0 : queryData.propertyControls) || {};
  ...
  return { query, queryParent, queryData, propertyControlsById, propertyControlsByName, childrenFunction };
}
...
function CMSCounter(props) {
  ...
  return /* @__PURE__ */ _jsxs("div", { style: { color: props.fontColor, userSelect: props.textSelect ? "auto" : "none", margin: 0, whiteSpace: props.style?.width ? void 0 : "nowrap", ...props.font, ...props.style }, children: [prefix, formatNumber(items, props.commas), suffix] });
}
CMSCounter.displayName = "CMS Item Counter";
addPropertyControls(CMSCounter, { collectionList: { type: ControlType.ComponentInstance }, placeholder: { type: ControlType.Number, defaultValue: 10, min: 0, step: 1, description: "Placeholder number is shown in the editor." }, commas: { type: ControlType.Boolean, defaultValue: true }, fontColor: { type: ControlType.Color, defaultValue: "#000" }, font: { type: "font", controls: "extended", defaultFontType: "sans-serif", defaultValue: { fontSize: 14, lineHeight: 1 } }, transform: { type: ControlType.Object, optional: true, controls: { plural: { type: ControlType.Boolean, defaultValue: false, enabledTitle: "On", disabledTitle: "Off" }, prefix: { type: ControlType.String, hidden(props) {
  return props.plural;
} }, suffix: { type: ControlType.String, hidden(props) {
  return props.plural;
} }, singularPrefix: { type: ControlType.String, placeholder: "Singular Prefix", hidden(props) {
  return !props.plural;
} }, singularSuffix: { type: ControlType.String, placeholder: "Singular Suffix", hidden(props) {
  return !props.plural;
} }, pluralPrefix: { type: ControlType.String, placeholder: "Plural Prefix", hidden(props) {
  return !props.plural;
} }, pluralSuffix: { type: ControlType.String, placeholder: "Plural Suffix", hidden(props) {
  return !props.plural;
...
import { addPropertyControls as e4, ControlType as t4, QueryCache as l2, QueryEngine as i2 } from "unframer";
...
var f = u({ "../../../node_modules/dataloader/index.js"(t32, e42) {
  ...
  function s2(t42, e5, r3) {
    a2(e5);
    for (var n3 = 0; n3 < e5.keys.length; n3++) t42.clear(e5.keys[n3]), e5.callbacks[n3].reject(r3);
  }
  function a2(t42) {
    if (t42.cacheHits) for (var e5 = 0; e5 < t42.cacheHits.length; e5++) t42.cacheHits[e5]();
  }
  function o22(t42) {
...
function _(e42, r22, n22) {
  let i22 = e42.value.length, s2 = r22.value.length;
  if (i22 < s2) return -1;
  if (i22 > s2) return 1;
  for (let s3 = 0; s3 < i22; s3++) {
    let i3 = e42.value[s3], a2 = r22.value[s3], o22 = t.compare(i3, a2, n22);
    if (0 !== o22) return o22;
  }
  return 0;
}
...
function tu(e42, r22, n22) {
  let i22 = Object.keys(e42.value).sort(), s2 = Object.keys(r22.value).sort();
  ...
  for (let a2 = 0; a2 < i22.length; a2++) {
    ...
    if (o22 < u22) return -1;
    if (o22 > u22) return 1;
    let l22 = e42.value[o22] ?? null, h2 = r22.value[u22] ?? null, c2 = t.compare(l22, h2, n22);
    if (0 !== c2) return c2;
  }
  return 0;
}
...
async function tE(t32, e42) {
  ...
  let h2 = new tM(), c2 = 0;
  for (let t42 of r22) {
    let e5 = t42.to - t42.from, r3 = c2 + e5, n3 = l22.subarray(c2, r3);
...
var tM = class {
  ...
  write(t32, e42) {
    let r22 = t32, n22 = r22 + e42.length, i22 = 0, s2 = this.chunks.length;
    for (; i22 < s2; i22++) {
    ...
    let a2 = { start: r22, end: n22, data: e42 }, o22 = s2 - i22;
...
function tF(t32) {
  ...
  let e42 = [...t32].sort((t42, e5) => t42.from - e5.from), r22 = [];
  for (let t42 of e42) {
    let e5 = r22.length - 1, n22 = r22[e5];
    n22 && t42.from <= n22.to ? r22[e5] = { from: n22.from, to: Math.max(n22.to, t42.to) } : r22.push(t42);
  }
  return r22;
}
var tA = class e3 {
  static read(r22) {
    ...
    for (let e42 = 0; e42 < i22; e42++) {
      let e5 = r22.readString(), i3 = t.read(r22);
      n22.setField(e5, i3);
    }
    return n22;
  }
...
var tO = class {
  scanItems() {
    return this.itemsPromise ??= tL(this.url).then(async (t32) => {
      ...
      let e42 = await t32.arrayBuffer(), r22 = new Uint8Array(e42), n22 = new y(r22), i22 = [], s2 = n22.readUint32();
      for (let t42 = 0; t42 < s2; t42++) {
        let t5 = n22.getOffset(), e5 = tA.read(n22), r3 = n22.getOffset() - t5, s3 = new O(this.id, t5, r3), a2 = s3.toString(), o22 = { pointer: a2, data: e5.getData() };
  ...
  constructor(t32, e42) {
    this.id = t32, this.url = e42, c(this, "itemsPromise"), c(this, "itemLoader", new g.default(async (t42) => {
      ...
      return r22.map((e6, r3) => {
        let n22 = new y(e6), i22 = tA.read(n22), s2 = t42[r3];
        return I(s2, "Missing pointer"), { pointer: s2, data: i22.getData() };
      });
    }));
  }
};
...
var r2 = [t3(e2, "richText"), t3(e2, "richText1"), t3(e2, "richText2"), t3(e2, "richText3"), t3(e2, "richText4"), t3(e2, "richText5"), t3(e2, "richText6"), t3(e2, "richText7"), t3(e2, "richText8"), t3(e2, "richText9"), t3(e2, "richText10"), t3(e2, "richText11"), t3(e2, "richText12"), t3(e2, "richText13"), t3(e2, "richText14"), t3(e2, "richText15"), t3(e2, "richText16"), t3(e2, "richText17"), t3(e2, "richText18"), t3(e2, "richText19"), t3(e2, "richText20"), t3(e2, "richText21"), t3(e2, "richText22"), t3(e2, "richText23")];
...
// /:https://framerusercontent.com/modules/g0Nz5LZJx3cYVkiD7uS1/JGIdW4ek1nGSKkTT9gya/FQ9Fz288R.js
var n2 = { E5Kf_kQMG: { isNullable: true, type: t4.RichText }, gM8_SX4ka: { isNullable: true, type: t4.String }, id: { isNullable: false, type: t4.String }, L2np3nwpe: { isNullable: true, type: t4.RichText }, ljOVMfd7C: { isNullable: true, type: t4.String }, nextItemId: { isNullable: true, type: t4.String }, previousItemId: { isNullable: true, type: t4.String }, SVUUOmaTq: { isNullable: true, type: t4.RichText }, tittXOToG: { isNullable: true, type: t4.String }, UbLNj3BJV: { isNullable: true, type: t4.String }, w12FzdhrB: { isNullable: true, type: t4.Boolean }, Y3ljWbYbb: { isNullable: true, type: t4.String } };
var o2 = [];
var u2 = (e22) => {
  let t22 = o2[e22];
...
var p2 = new i2();
var d2 = new l2(p2);
var y2 = { collectionByLocaleId: { default: new tx({ chunks: [new URL("./FQ9Fz288R-chunk-default-0.framercms", "https://framerusercontent.com/modules/g0Nz5LZJx3cYVkiD7uS1/JGIdW4ek1nGSKkTT9gya/FQ9Fz288R.js").href.replace("/modules/", "/cms/")], indexes: [], resolveRichText, resolveVectorSetItem: u2, schema: n2 }) }, displayName: "Careers" };
var stdin_default = y2;
e4(y2, { tittXOToG: { defaultValue: "", title: "Role", type: t4.String }, Y3ljWbYbb: { defaultValue: "", title: "Department", type: t4.String }, w12FzdhrB: { defaultValue: true, title: "Remote", type: t4.Boolean }, gM8_SX4ka: { defaultValue: "", title: "Location", type: t4.String }, UbLNj3BJV: { defaultValue: "", placeholder: "We're looking for...", title: "Description", type: t4.String }, SVUUOmaTq: { defaultValue: "", title: "What you'll do", type: t4.RichText }, E5Kf_kQMG: { defaultValue: "", title: "Who you are", type: t4.RichText }, L2np3nwpe: { defaultValue: "", title: "What we offer", type: t4.RichText }, ljOVMfd7C: { title: "Slug", type: t4.String }, previousItemId: { dataIdentifier: "local-module:collection/FQ9Fz288R:default", title: "Previous", type: t4.CollectionReference }, nextItemId: { dataIdentifier: "local-module:collection/FQ9Fz288R:default", title: "Next", type: t4.CollectionReference } });

// /:https://framerusercontent.com/modules/FVPdLQuH5FgmfojRjedc/zU9EhP4CHWDDE1h07lkm/nMVen8H4h.js
import { fontStore } from "unframer";
fontStore.loadFonts(["GF;Geist Mono-500", "Inter-Bold", "Inter-BoldItalic", "Inter-Italic"]);
