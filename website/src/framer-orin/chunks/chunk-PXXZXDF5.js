...
function TextShimmer({ font, content, color, shimmer, size, speed, userSelect, rotation, delay, tag, direction }) {
  ...
  return /* @__PURE__ */ _jsxs("div", { style: { userSelect: userSelect ? "auto" : "none", position: "relative" }, children: [/* @__PURE__ */ _jsx(Tag, { style: { ...font, color, marginBlockStart: "0px", marginBlockEnd: "0px" }, children: content }), /* @__PURE__ */ _jsx(Tag, { "aria-hidden": "true", className: classNameRef.current, style: { ...font, color: "transparent", position: "absolute", top: 0, left: 0, right: 0, bottom: 0, zIndex: 1, marginBlockStart: "0px", marginBlockEnd: "0px", pointerEvents: "none" }, children: content })] });
}
TextShimmer.displayName = "Text Shimmer";
addPropertyControls(TextShimmer, { font: { type: ControlType.Font, title: "Font", defaultValue: "Inter", controls: "extended" }, content: { type: ControlType.String, title: "Content", defaultValue: "Learn Framer With Framer University" }, color: { type: ControlType.Color, title: "Color", defaultValue: "#FFFFFF1A" }, shimmer: { type: ControlType.Color, title: "Shimmer", defaultValue: "#ffffff" }, size: { type: ControlType.Number, title: "Size", defaultValue: 30, step: 1, max: 100, min: 1 }, speed: { type: ControlType.Number, title: "Speed", defaultValue: 5, max: 10, min: 1, step: 1 }, direction: { type: ControlType.Enum, title: "Direction", defaultValue: "left", options: ["left", "right"], optionTitles: ["Left", "Right"], displaySegmentedControl: true, segmentedControlDirection: "horizontal", optionIcons: ["direction-left", "direction-right"] }, userSelect: { title: "User Select", type: ControlType.Boolean, defaultValue: false }, rotation: { type: ControlType.Number, title: "Rotation", defaultValue: 90, min: 45, unit: "\xB0", max: 135, step: 1 }, delay: { type: ControlType.Number, title: "Delay", defaultValue: 0, min: 0, max: 10, step: 0.1 }, tag: { type: ControlType.Enum, title: "Tag", defaultValue: "p", displaySegmentedControl: true, segmentedControlDirection: "horizontal", options: ["h1", "h2", "h3", "p"], optionTitles: ["H1", "H2", "H3", "P"], description: "More components at [Framer University](https://frameruni.link/cc)." } });
