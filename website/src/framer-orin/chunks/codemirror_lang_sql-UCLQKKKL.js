...
// /:https://framerusercontent.com/modules/ErpiHuOpMsJgQursm47q/I5FT7NNE5VTy4COCCEVL/codemirror_lang_sql.js
var whitespace = 36;
var LineComment = 1;
var BlockComment = 2;
var String$1 = 3;
...
var defaults = { backslashEscapes: false, hashComments: false, spaceAfterDashes: false, slashComments: false, doubleQuotedStrings: false, doubleDollarQuotedStrings: false, unquotedBitLiterals: false, treatBitsAsBytes: false, charSetCasts: false, operatorChars: "*+-%<>!=&|~^/", specialVar: "?", identifierQuotes: '"', words: /* @__PURE__ */ keywords(SQLKeywords, SQLTypes) };
...
function completeKeywords(keywords2, upperCase) {
  let completions = Object.keys(keywords2).map((keyword) => ({ label: upperCase ? keyword.toUpperCase() : keyword, type: keywords2[keyword] == Type ? "type" : keywords2[keyword] == Keyword ? "keyword" : "variable", boost: -1 }));
  return ifNotIn(["QuotedIdentifier", "SpecialVar", "String", "LineComment", "BlockComment", "."], completeFromList(completions));
}
var parser = /* @__PURE__ */ parser$1.configure({ props: [/* @__PURE__ */ indentNodeProp.add({ Statement: /* @__PURE__ */ continuedIndent() }), /* @__PURE__ */ foldNodeProp.add({ Statement(tree) {
...
var __FramerMetadata__ = { "exports": { "PLSQL": { "type": "variable", "annotations": { "framerContractVersion": "1" } }, "MSSQL": { "type": "variable", "annotations": { "framerContractVersion": "1" } }, "keywordCompletion": { "type": "function", "annotations": { "framerContractVersion": "1" } }, "keywordCompletionSource": { "type": "function", "annotations": { "framerContractVersion": "1" } }, "SQLite": { "type": "variable", "annotations": { "framerContractVersion": "1" } }, "sql": { "type": "function", "annotations": { "framerContractVersion": "1" } }, "schemaCompletion": { "type": "function", "annotations": { "framerContractVersion": "1" } }, "StandardSQL": { "type": "variable", "annotations": { "framerContractVersion": "1" } }, "SQLDialect": { "type": "variable", "annotations": { "framerContractVersion": "1" } }, "PostgreSQL": { "type": "variable", "annotations": { "framerContractVersion": "1" } }, "schemaCompletionSource": { "type": "function", "annotations": { "framerContractVersion": "1" } }, "Cassandra": { "type": "variable", "annotations": { "framerContractVersion": "1" } }, "MySQL": { "type": "variable", "annotations": { "framerContractVersion": "1" } }, "MariaSQL": { "type": "variable", "annotations": { "framerContractVersion": "1" } }, "__FramerMetadata__": { "type": "variable" } } };
export {
  Cassandra,
  MSSQL,
  MariaSQL,
