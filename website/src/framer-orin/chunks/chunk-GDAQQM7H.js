...
// /:https://framerusercontent.com/modules/wFkXxZqfKOPeEQtsYrsa/772bfdCR3vXAPJJXnNsc/codemirror_state.js
var Text = class {
  /**
...
// /:https://framerusercontent.com/modules/wKCR2JyUW8wZdYweJrou/QTymt9nRixOIrUSZrfIJ/codemirror_view.js
...
function updateAttrs(dom, prev, attrs) {
  ...
  if (attrs) {
    for (let name2 in attrs) if (!(prev && prev[name2] == attrs[name2])) dom.setAttribute(changed = name2, attrs[name2]);
  }
  return !!changed;
}
...
function computeOrder(line, direction) {
  ...
  if (outerType == 1) {
    for (let i2 = 0; i2 < len; ) {
      ...
      while (i2 < len && rtl == (types[i2] != 1)) i2++;
      if (rtl) {
    ...
    for (let i2 = 0; i2 < len; ) {
      ...
      while (i2 < len && rtl == (types[i2] == 2)) i2++;
...
var DocView = class extends ContentView {
  ...
  coordsAt(pos, side) {
    for (let off = this.length, i2 = this.children.length - 1; ; i2--) {
      ...
      if (pos > start || pos == start && child.type != BlockType.WidgetBefore && child.type != BlockType.WidgetAfter && (!i2 || side == 2 || this.children[i2 - 1].breakAfter || this.children[i2 - 1].type == BlockType.WidgetBefore && side > -2)) return child.coordsAt(pos - start, side);
      off = start;
    }
  }
...
var InputState = class {
  ...
  ensureHandlers(view, plugins) {
    ...
    let handlers2;
    this.customHandlers = [];
    for (let plugin2 of plugins) if (handlers2 = (_a2 = plugin2.update(view).spec) === null || _a2 === void 0 ? void 0 : _a2.domEventHandlers) {
      this.customHandlers.push({ plugin: plugin2.value, handlers: handlers2 });
      for (let type in handlers2) if (this.registeredEvents.indexOf(type) < 0 && type != "scroll") {
...
var PendingKeys = [{ key: "Backspace", keyCode: 8, inputType: "deleteContentBackward" }, { key: "Enter", keyCode: 13, inputType: "insertParagraph" }, { key: "Delete", keyCode: 46, inputType: "deleteContentForward" }];
...
var MouseSelection = class {
  ...
  select(event) {
    ...
    if (this.mustSelect || !selection.eq(view.state.selection) || selection.main.assoc != view.state.selection.main.assoc) this.view.dispatch({ selection, userEvent: "select.pointer" });
    ...
    if (change.from >= sel.from && change.to <= sel.to && change.to - change.from >= (sel.to - sel.from) / 3 && (!newSel || newSel.main.empty && newSel.main.from == change.from + change.insert.length) && view.inputState.composing < 0) {
      ...
      if (startState.selection.ranges.length > 1 && view.inputState.composing >= 0 && change.to <= sel.to && change.to >= sel.to - 10) {
        ...
        tr = startState.changeByRange((range) => {
          ...
          // ignored.
          compositionRange && range.to >= compositionRange.from && range.from <= compositionRange.to) return { range };
...
var EditorView = class {
  ...
  */
  ...
  updateAttrs() {
    ...
    let contentAttrs = { spellcheck: "false", autocorrect: "off", autocapitalize: "off", translate: "no", contenteditable: !this.state.facet(editable) ? "false" : "true", class: "cm-content", style: `${browser.tabSize}: ${this.state.tabSize}`, role: "textbox", "aria-multiline": "true" };
...
function buildKeymap(bindings, platform = currentPlatform) {
  ...
  let add = (scope, key, command, preventDefault) => {
    ...
    for (let i2 = 1; i2 < parts.length; i2++) {
      ...
      if (!scopeObj[prefix]) scopeObj[prefix] = { preventDefault: true, run: [(view) => {
...
var themeSpec = { ".cm-line": { "& ::selection": { backgroundColor: "transparent !important" }, "&::selection": { backgroundColor: "transparent !important" } } };
...
}, widgetMarker: () => null, lineMarkerChange: (update) => update.startState.facet(lineNumberConfig) != update.state.facet(lineNumberConfig), initialSpacer(view) {
...
// /:https://framerusercontent.com/modules/CO9ruPlVDRTCLVInyri7/ye873rtFsAyZVFu9x2He/lezer_common.js
...
// /:https://framerusercontent.com/modules/rOWwbZHN39cczduPnzmw/seDszB8oQDQQyH7PIqkK/lezer_highlight.js
var nextTagID = 0;
var Tag = class {
  /**
...
// /:https://framerusercontent.com/modules/aJsTBlWNkIaM900KNIXT/O6D7zESNv8FU9mcfHZ5S/codemirror_language.js
...
// /:https://framerusercontent.com/modules/MiFWyNBz6FaRwOOEYJ4H/nqI70oaHl4AhH5rIUMv4/lezer_lr.js
var Stack = class {
  /// @internal
  toString() {
