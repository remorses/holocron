...
<Tip>
Page slugs in `docs.json` map directly to file paths. `docs/getting-started` loads `docs/getting-started.mdx`.
</Tip>

</Aside>

Here is a full `server.tsx` with a custom homepage:
