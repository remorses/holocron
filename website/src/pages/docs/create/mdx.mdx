...
Native heading elements (`<h1>` through `<h6>`) are an exception: Holocron automatically unwraps the paragraph wrapper so both multi-line and single-line forms produce the same clean output.
