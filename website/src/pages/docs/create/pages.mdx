...
| `mode`                | string    | Page layout mode: `"default"`, `"compact"`, `"center"`, or `"custom"`. Compact hides the sidebar assistant; set `assistant.display` to `floating`. See [Layout](../customize/layout.mdx) |
