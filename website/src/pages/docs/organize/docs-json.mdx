...
prompt: |
  Write the docs.json guide from @/vite/src/schema.ts, @/website/docs.json,
  @/vite/src/lib/mcp/provider.ts, and @/vite/src/lib/openapi/provider.ts.
title: docs.json
