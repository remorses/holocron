...
prompt: |
  Write the icons guide from @/vite/src/lib/resolve-icons.ts and @/vite/src/lib/collect-icons.ts.
  Cover lucide, fontawesome, prefixed icon names, and local SVG file icons.
title: Icons
