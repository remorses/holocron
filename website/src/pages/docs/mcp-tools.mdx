...
prompt: |
  Write the MCP docs guide from @/vite/src/lib/mcp/provider.ts and @/vite/src/lib/mcp/render-mcp.tsx.
  Use @https://modelcontextprotocol.io for protocol background.
title: MCP Docs
