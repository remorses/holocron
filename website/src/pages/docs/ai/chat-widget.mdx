...
prompt: |
  Write the embeddable chat widget guide from @/vite/src/chat/chat-widget.tsx.
  Use @https://developer.chrome.com/docs/web-platform/view-transitions and @https://purl.org/nickreserved/modelcontext.
