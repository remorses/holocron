...
Use **floating** with [compact layout](../customize/layout.mdx) too. Compact mode removes the right aside, so the default sidebar assistant is hidden unless you set `display` to `floating`.
