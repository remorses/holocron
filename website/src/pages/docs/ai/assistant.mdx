...
prompt: |
  Write the AI assistant guide from @/vite/src/schema.ts, @/vite/src/components/sidebar-assistant.tsx, @/vite/src/components/holocron-chat-bridge.tsx, and @/vite/src/app-factory.tsx.
title: AI Assistant
...
[Compact layout](../customize/layout.mdx) in `docs.json` defaults to **floating** unless you set `assistant.display` yourself. Compact removes the right aside, so the sidebar widget cannot show.
