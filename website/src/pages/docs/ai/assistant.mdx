...
By default, the AI assistant widget occupies the right sidebar. If you prefer a traditional **table of contents** instead (or alongside the widget), add the `TableOfContentsPanel` component to your page:
...
This renders a sticky "On this page" panel with heading links and active-state highlighting as the user scrolls. When the AI widget is enabled, it appears above the TOC panel automatically. When disabled, the TOC panel takes the full sidebar.
