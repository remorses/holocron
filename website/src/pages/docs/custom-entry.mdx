...
prompt: |
  Write the custom entry guide from @/website/src/server.tsx and @/website/vite.config.ts.
  Use @https://github.com/remorses/holocron/tree/main/website as the live example.
title: Custom Entry
