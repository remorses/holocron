...
icon: credit-card
prompt: |
  Write the pricing page from @/website/src/lib/credits.ts,
  @/website/src/deploy-api.ts, and @/website/src/maintain-api.ts.

  Explain the Free and Pro plans, monthly and yearly prices, AI credits,
  deployments, custom domains, subpath hosting, and Holocron Maintain.
---
