...
prompt: |
  Write the request and response examples guide from @/vite/src/components/markdown/code-card.tsx and @/vite/src/lib/remark-sidebar-components.ts.
...
- **`x-codeSamples`** on the operation (SDK / CLI snippets) as extra Request example tabs. See [SDK examples](./sdk-examples.mdx).
