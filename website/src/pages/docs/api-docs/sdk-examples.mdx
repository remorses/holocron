...
prompt: |
  Write the SDK examples guide from @/vite/src/lib/openapi/code-samples.ts.
  Use @https://heyapi.dev and @https://www.mintlify.com/docs/api-playground/adding-sdk-examples.
