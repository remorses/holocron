...
prompt: |
  Write the RequestExample and ResponseExample docs from @/vite/src/components/markdown/code-card.tsx.
title: Examples
...
- Use [`<Aside width={N}>`](./aside.mdx) when examples need a wider fixed rail than the default 230px. `RequestExample` already uses 460px.
