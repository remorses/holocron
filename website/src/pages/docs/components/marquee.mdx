...
Scroll partner or integration logos using `img` tags with relative paths from your `public/` folder. Set a uniform `height` to keep all logos visually aligned; the width scales proportionally.

```mdx
<Marquee duration={20} slowOnHover gap={24}>
  <img src="/logos/vercel.svg" alt="Vercel" height="32" />
  <img src="/logos/stripe.svg" alt="Stripe" height="32" />
  <img src="/logos/github.svg" alt="GitHub" height="32" />
  <img src="/logos/cloudflare.svg" alt="Cloudflare" height="32" />
  <img src="/logos/linear.svg" alt="Linear" height="32" />
</Marquee>
```
...
<Marquee duration={20} slowOnHover gap={24}>
  ...
  <img src="/logos/stripe.svg" alt="Stripe" height="32" className="dark:invert" />
  <img src="/logos/linear.svg" alt="Linear" height="32" className="dark:invert" />
</Marquee>
```

This works because `<img>` tags inside Marquee are automatically converted to Holocron's `Image` component at build time, which preserves `className`.
