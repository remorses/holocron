...
prompt: |
  Write GitHub Actions examples from @/cli/src/maintain-github.ts and @/cli/src/maintain.ts.
  Cover default-branch pushes, same-repository pull requests, schedules, OIDC authentication, full Git history, and concurrency behavior.
