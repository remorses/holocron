...
**When migrating an existing docs site**, write each `prompt` as if the page was authored from scratch. Keep it **a short summary** of what the page documents. Do not mention migration or the old docs URL, and do not add `@https://old-site/...` references — the source site is going away.
