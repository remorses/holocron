...
import { getOctokit, createNewRepo, doesRepoExist } from '../lib/github.server'
      ...
      <Form method='post' className='flex flex-col gap-6 w-full max-w-md'>
        <div className='flex flex-col gap-2'>
          ...
          <p className='text-sm text-muted-foreground'>
            This will create a repository at github.com/
...
export async function action({ request, params }: Route.ActionArgs) {
  ...
  if (!branch || !githubInstallation) {
    throw new Response('Branch or GitHub installation not found', {
      status: 404,
    })
  }
