/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2f114248775d6d9828d90254f05cc33a)
// Runtime types generated with workerd@1.20260410.1 2026-04-20 nodejs_compat
declare namespace Cloudflare {
	interface PreviewEnv {
		DB: D1Database;
		AI: Ai;
		BETTER_AUTH_URL: "https://preview.holocron.so";
	...
	interface Env {
		DB: D1Database;
		AI: Ai;
		BETTER_AUTH_URL: "https://preview.holocron.so" | "https://holocron.so";
		BETTER_AUTH_SECRET: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		CF_API_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "CF_API_TOKEN" | "AIG_GATEWAY_TOKEN">> {}
}
