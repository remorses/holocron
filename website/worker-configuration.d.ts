/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0e01515fc8000bb645493023cffe2555)
// Runtime types generated with workerd@1.20260526.1 2026-04-14 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	AI_LOGO_KV: KVNamespace;
	...
	HOLOCRON_TOKEN: string;
	CLOUDFLARE_HOSTING_API_TOKEN: string;
	CLOUDFLARE_HOSTING_ZONE_ID: string;
	AI_GATEWAY_API_KEY: string;
	VERCEL_ACCESS_TOKEN: string;
	VERCEL_TEAM_ID: string;
	USAGE_COUNTER: DurableObjectNamespace /* UsageCounter */;
	CONFIG_OVERRIDE: DurableObjectNamespace /* ConfigOverrideDO */;
	CHAT_SESSION: DurableObjectNamespace /* ChatSessionDO */;
	OG_WORKER: Fetcher /* holocron-og-preview */ | Fetcher /* holocron-og */;
}
declare namespace Cloudflare {
	interface PreviewEnv {
		...
		CONFIG_OVERRIDE: DurableObjectNamespace /* ConfigOverrideDO */;
		CHAT_SESSION: DurableObjectNamespace /* ChatSessionDO */;
		OG_WORKER: Fetcher /* holocron-og-preview */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "STRADA_PROJECT_ID" | "STRADA_TOKEN" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "HOLOCRON_TOKEN" | "CLOUDFLARE_HOSTING_API_TOKEN" | "CLOUDFLARE_HOSTING_ZONE_ID" | "AI_GATEWAY_API_KEY" | "VERCEL_ACCESS_TOKEN" | "VERCEL_TEAM_ID">> {}
}
