/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 57d0501afae8170e18918b3ee4ddb76a)
// Runtime types generated with workerd@1.20260410.1 2026-04-14 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface PreviewEnv {
		USAGE_KV: KVNamespace;
		DB: D1Database;
		CLOUDFLARE_ACCOUNT_ID: "103e73569e2f6d4aea0fb679ceb8709b";
		HOLOCRON_AI_GATEWAY_URL: "https://preview.holocron.so/api/ai/v1";
		BETTER_AUTH_SECRET: string;
		BETTER_AUTH_URL: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		CLOUDFLARE_AI_API_TOKEN: string;
		AIG_GATEWAY_TOKEN: string;
	}
	interface Env {
		USAGE_KV: KVNamespace;
		DB: D1Database;
		CLOUDFLARE_ACCOUNT_ID: "103e73569e2f6d4aea0fb679ceb8709b";
		HOLOCRON_AI_GATEWAY_URL: "https://preview.holocron.so/api/ai/v1" | "https://holocron.so/api/ai/v1";
		BETTER_AUTH_SECRET: string;
		BETTER_AUTH_URL: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "HOLOCRON_AI_GATEWAY_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "CLOUDFLARE_AI_API_TOKEN" | "AIG_GATEWAY_TOKEN" | "CF_API_TOKEN">> {}
}
