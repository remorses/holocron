    ...
    () => {
        test('example domain', async () => {
            ...
            expect(result).toMatchInlineSnapshot(`
              ...
              **Source:** https://docs.holocron.so/essentials/images.md?startLine=34#embeds-and-html-elements

              src: https://www.youtube.com/embed/4KzFe50RQkQ

              ━━━

              **Source:** https://docs.holocron.so/essentials/images.md?startLine=14#using-markdown

              Using Markdown

              ━━━

              **Source:** https://docs.holocron.so/sync-architecture.md

              FumaBase Sync Architecture

              ━━━

              **Source:** https://docs.holocron.so/sync-architecture.md?startLine=192#assetforsync-syncts67-105

              Union type representing different syncable assets:

              ━━━

              **Source:** https://docs.holocron.so/sync-architecture.md#database-schema-inferred
