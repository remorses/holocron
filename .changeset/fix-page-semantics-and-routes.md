...
- Render one frontmatter page-title H1 when MDX starts with a callout or has no body content. Skip that generated H1 when the page already starts with any heading. H2-H6 keep their source depth, body H1 headings become H2, and repeated title headings are removed from the body TOC. Set `hideTitle: true` to opt out.
