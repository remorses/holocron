...
<CardGroup cols={2}>
  <Card title="Interactive workflow building" icon="mouse-pointer-click" href="./interactive-workflow-building">
    Show the agent your workflow manually and let it turn your actions into code.
  </Card>

  <Card title="Convert to network requests" icon="network" href="./convert-to-network-requests">
