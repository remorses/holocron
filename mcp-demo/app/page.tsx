...
const mcpServer = {
  ...
  description: 'A comprehensive Model Context Protocol server that provides tools for interacting with the local filesystem. This server enables AI assistants to read, write, list, and search files and directories, as well as execute system commands safely.',
...
const realMCPTools: Tool[] = [
  {
    name: 'read_file',
    description: 'Read the complete contents of a file from the filesystem. This tool can handle various text file formats and encodings.',
    annotations: {
      title: 'Read File',
      readOnlyHint: true,
      openWorldHint: false,
  ...
  {
    name: 'write_file',
    description: 'Write content to a file, creating it if it doesn\'t exist or overwriting if it does. This tool handles text content and ensures proper file encoding.',
    annotations: {
      title: 'Write File',
      readOnlyHint: false,
  ...
  {
    name: 'list_directory',
    description: 'List the contents of a directory, showing files and subdirectories. Can optionally show hidden files and provide detailed information.',
    annotations: {
  ...
  {
    name: 'search_files',
    description: 'Search for files matching a pattern within a directory tree. Supports glob patterns and regular expressions for flexible file discovery.',
    annotations: {
      title: 'Search Files',
      readOnlyHint: true,
      openWorldHint: false,
  ...
  },
  {
    ...
    description: 'Execute a shell command in the system. Useful for running build scripts, system utilities, or other command-line tools. Returns both stdout and stderr.',
    annotations: {
      ...
      content: [
        {
          ...
          result: {
            files: [
              { name: 'index.ts', type: 'file', size: 1250, modified: '2024-01-15T10:30:00Z' },
              { name: 'components', type: 'directory', size: 4096, modified: '2024-01-15T09:15:00Z' },
              { name: 'utils.ts', type: 'file', size: 890, modified: '2024-01-14T16:20:00Z' },
              { name: 'types.ts', type: 'file', size: 456, modified: '2024-01-14T14:45:00Z' }
            ]
          }
        }
      ]
    ...
    <div className="min-h-screen prose bg-background">
      <div className="container mx-auto px-4 py-8">
        ...
        <footer className="mt-16 pt-8 border-t text-center text-muted-foreground">
          <p className="text-sm">
            This demo showcases MCP tools using the Fumadocs OpenAPI component system.
            The tools shown are based on real filesystem MCP implementations.
          </p>
        </footer>
      </div>
    </div>
